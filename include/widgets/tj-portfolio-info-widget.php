...
class TJ_Portfolio_Info_Widget  extends WP_Widget {
	...
	public function __construct() {
		parent::__construct('TJ_Portfolio_Info_Widget', esc_html__('TJ Portfolio Info', 'tjcore'), array(
			'description' => esc_html__('TJ Portfolio Info Widget', 'tjcore'),
		));
	}
