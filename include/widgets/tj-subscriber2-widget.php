...
class TJ_Subscriber2_Widget  extends WP_Widget {
	...
	public function __construct() {
		parent::__construct('TJ_Subscriber2_Widget', esc_html__('TJ Footer Subscriber 2', 'tjcore'), array(
			'description' => esc_html__('TJ Subscriber Widget', 'tjcore'),
		));
	}
