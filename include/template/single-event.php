               ...
               <div class="course__meta-2 d-sm-flex align-items-center mb-30">
                  <div class="course__teacher-3 d-flex align-items-center mr-70 mb-30">
                     ...
                     <div class="course__teacher-info-3">
                        <h5><?php echo esc_html__('Speaker', 'tjcore'); ?></h5>
                        <p><a href="#"><?php echo esc_html($speaker_name); ?></a></p>
                     </div>
                  </div>
                  <div class="course__update mr-80 mb-30">
                     <h5><?php echo esc_html__('Date', 'tjcore'); ?></h5>
                     <p>
                  ...
                  <div class="event__info">
                        ...
                        <ul>
                           <li class="d-flex align-items-center">
                              ...
                              <div class="event__info-item">
                                 <h5><span><?php echo esc_html__('End Time:', 'tjcore'); ?> </span> <?php echo esc_html($end_time); ?></h5>
                              </div>
                           </li>
                           <li class="d-flex align-items-center">
                              <div class="event__info-icon">
                              ...
                              <div class="event__info-item">
                                 <h5><span><?php echo esc_html__('Start Time:', 'tjcore'); ?> </span> <?php echo esc_html($start_time); ?></h5>
                              </div>
                           </li>
                           <li class="d-flex align-items-center">
                              <div class="event__info-icon">
                              ...
                              <div class="event__info-item">
                                 <h5><span><?php echo esc_html__('Venue:', 'tjcore'); ?> </span> <?php echo tribe_get_address(); ?>, <?php echo tribe_get_city(); ?></< /h5>
                              </div>
                           </li>
                        </ul>
                     </div>
                     <?php if (!empty($event_button_text)) : ?>
                        <div class="event__join-btn">
                           <a href="<?php echo esc_html($event_button_url); ?>" class="tj-btn text-center w-100"><?php echo esc_html($event_button_text); ?> <i class="far fa-arrow-right"></i></a>
                        </div>
                     <?php endif; ?>
                  </div>
               </div>
