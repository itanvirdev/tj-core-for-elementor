    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'layout-1' => esc_html__('Grid Style 1', 'tjcore'),
                    'layout-2' => esc_html__('Grid Style 2', 'tjcore'),
                    'layout-3' => esc_html__('Grid Style 3', 'tjcore'),
                    'layout-4' => esc_html__('Grid Style 4', 'tjcore'),
                ],
                'default' => 'layout-1',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Show difficulty', 'tjcore'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'tjcore'),
                'label_off' => esc_html__('Hide', 'tjcore'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Show wishlist', 'tjcore'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'tjcore'),
                'label_off' => esc_html__('Hide', 'tjcore'),
                'return_value' => 'yes',
                                                    ...
                                                    <li>
                                                        <div class="course__lesson-3">
                                                            <a href="#">
                                                                ...
                                                                <?php echo $tutor_lesson_count; ?> <?php echo esc_html__('videos', 'tjcore'); ?>
                                                            </a>
                                                        </div>
                                                    </li>
                                                <?php endif; ?>
                                                    ...
                                                    <li>
                                                        <div class="course__review-3">
                                                            <a href="#">
                                                                ...
                                                                ?>
                                                                <?php echo esc_html__('Reviews', 'tjcore'); ?>
                                                            </a>
                                                        </div>
                                                    </li>
                                                <?php endif; ?>
                            ...
                            <div class="course__filter masonary-menu text-center mb-30">
                                <div class="nav-tabs">
                                    ...
                                    foreach ($filter_list as $list) : ?>
                                        <?php if ($i === 1) : $i++; ?>
                                            <button class="active nav-link" data-filter="*"><?php echo esc_html__('See All', 'tjcore'); ?></button>
                                            ...
                                            <?php if ('yes' === $settings['tp_lessons_show']) : ?>
                                                <div class="course__lesson">
                                                    <a href="<?php print get_the_permalink() ?>"><svg width="14" height="16" viewBox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        <?php echo $tutor_lesson_count; ?> <?php print esc_html__('lessons', 'tjcore'); ?>
                                                    </a>
                                                </div>
                                            <?php endif; ?>
                                        </div>
