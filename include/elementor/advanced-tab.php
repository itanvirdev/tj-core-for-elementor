	...
	protected function register_controls() {
		...
		$repeater->add_control(
			...
			[
				...
				'default' => __('Tab Title', 'tjcore'),
				'placeholder' => __('Type Tab Title', 'tjcore'),
				'dynamic' => [
					'active' => true,
				]
			]
...
?>
		...
		?>
			...
			<section class="feature" id="tj-features">
				<div class="container">
					<div class="row">
						<div class="col-12">
