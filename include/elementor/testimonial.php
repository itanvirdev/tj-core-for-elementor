...
class TP_Testimonial extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            'review_sub',
            [
                'label' => esc_html__('Reviewe Subject', 'tjcore'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('Code Quality!', 'tjcore'),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('- CEO at YES Germany', 'tjcore'),
                'label_block' => true,
            ]
        );
        $repeater->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'reviewer_name' => esc_html__('Rasalina William', 'tjcore'),
                        'reviewer_title' => esc_html__('- CEO at YES Germany', 'tjcore'),
                        'review_content' => esc_html__('Put your trust in us &share in our people with a passion.We are motivated by the satisfaction H.Spond Asset Management is made up of a team of expert, committed and experienced for of clients financial markets. Our goal is to achieve continuous.', 'tjcore'),
                    ],
                    [
                        'reviewer_name' => esc_html__('Rasalina William', 'tjcore'),
                        'reviewer_title' => esc_html__('- CEO at YES Germany', 'tjcore'),
